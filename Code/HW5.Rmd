...
#parameters: fit.eval - function to use for fit, init,gen - function to generate parameters for fit, 
#perturb.gen - function to randomly perturb parameters, in.bounds - function to check whether value is within the given bounds, 
